...
Now we cluster our data using kmeans, pam (divisive) and single, average, complete and ward linkage (hierarchical). For devisive metods we use k=5. For hierarchical we plot dendrograms and cut them to get 5 clusters as well.
